...
export const mdxComponents = {
    ...
    h2: (props) => <h2 className="text-2xl md:text-3xl tracking-tight font-medium mt-10 mb-4" {...props} />,
    h3: (props) => <h3 className="text-xl tracking-tight font-medium mt-8 mb-3" {...props} />,
