        ...
        <footer>
            ...
            >
                <div className="relative h-[calc(100vh+400px)] md:h-[calc(100vh+450px)] -top-[100vh]">
                    <div className="flex flex-col justify-between w-full h-[400px] md:h-[450px] sticky top-[calc(100vh-400px)] md:top-[calc(100vh-450px)] 
                        ...
                        <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6 md:gap-0">
                            ...
                            <div className="text-left md:text-right flex flex-col md:flex-row leading-none gap-2 md:gap-3 text-sm md:text-base">
                                <p>{lang("createdBy")}</p>
